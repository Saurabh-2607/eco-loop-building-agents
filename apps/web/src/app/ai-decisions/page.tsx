...
export default function AIDecisions() {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      {/* ── Row 1: Left Column Sidebar / Right Column Report Workspace ── */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        
        {/* Left Column (5/12 width): AI Reasoning, Comparison, and Accuracy Cards */}
        <div className="lg:col-span-5 flex flex-col gap-6 w-full">
          {/* AI Agent reasoning vertical timeline stepper */}
          <AIAgentThinking />

          {/* Before vs After Optimization Comparison Card */}
          <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 overflow-hidden flex flex-col shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-neutral-50/50 border border-neutral-100 rounded-xl space-y-3" style={{ borderRadius: 12 }}>
                  ...
                  <div className="space-y-2 text-xs font-semibold text-neutral-700">
                    <div className="flex justify-between items-center pb-2 border-b border-neutral-100/60">
                      <span className="text-neutral-450 font-medium">HVAC:</span>
                      <span className="text-neutral-900">{comparisonStats.before.hvac} kWh</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-neutral-100/60">
                      <span className="text-neutral-455 font-medium">Lighting:</span>
                ...
                <div className="p-4 bg-neutral-50/50 border border-neutral-100 rounded-xl space-y-3" style={{ borderRadius: 12 }}>
                  ...
                  <div className="space-y-2 text-xs font-semibold text-neutral-700">
                    ...
                    <div className="flex justify-between items-center pb-2 border-b border-neutral-100/60">
                      <span className="text-neutral-505 font-medium">Lighting:</span>
                ...
                <div className="p-4 bg-neutral-50/50 border border-neutral-100 rounded-xl flex flex-col justify-center items-center text-center space-y-2" style={{ borderRadius: 12 }}>
                  ...
                  <p className="text-[10px] text-neutral-450 font-semibold max-w-[160px] leading-relaxed">
          ...
          {/* Accuracy Stats Cards Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between p-4 space-y-2 shadow-sm">
              <span className="text-xs font-semibold text-neutral-500 block">Total Optimization Cycles</span>
              <div className="text-2xl font-bold text-neutral-900">{totalDecisions}</div>
              <p className="text-[10px] text-neutral-400">Total model execution calls</p>
            </Card>

            <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between p-4 space-y-2 shadow-sm">
              <span className="text-xs font-semibold text-neutral-500 block">Correct Decisions</span>
              <div className="text-2xl font-bold text-neutral-900">{correctDecisions}</div>
              <p className="text-[10px] text-neutral-400">Confirmed by building operator</p>
            </Card>

            <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between p-4 space-y-2 shadow-sm">
              <span className="text-xs font-semibold text-neutral-500 block">Incorrect Decisions</span>
              <div className="text-2xl font-bold text-neutral-900">{incorrectDecisions}</div>
              <p className="text-[10px] text-neutral-400">Rejected by operator overrides</p>
            </Card>

            <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between p-4 space-y-2 shadow-sm">
              <span className="text-xs font-semibold text-neutral-500 block">Agent Accuracy Index</span>
              <div className="text-2xl font-bold text-neutral-900">{correctDecisions + incorrectDecisions > 0 ? `${accuracyRate}%` : "100%"}</div>
              <p className="text-[10px] text-neutral-400">Evaluated criteria accuracy</p>
            </Card>
          </div>
        </div>

        {/* Right Column (7/12 width): AI Auditor Report (stretches to full height of left stack) */}
        <div className="lg:col-span-7 flex flex-col w-full min-h-[600px] lg:min-h-0">
          <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 overflow-hidden flex flex-col h-full shadow-sm">
            ...
            <CardContent className="p-4 flex-1 flex flex-col min-h-0">
              {aiReportLoading ? (
                ...
                <div className="bg-neutral-50/50 border border-neutral-100 p-6 rounded-xl flex-1 overflow-y-auto select-text" style={{ borderRadius: 12 }}>
                  <MarkdownRenderer text={aiReport} />
                </div>
              ) : (
                <div className="flex flex-col items-center justify-center py-20 text-center space-y-3 flex-1">
      ...
      {/* ── Row 2: Full-Width Decisions Timeline Log List ── */}
      <Card className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm flex flex-col overflow-hidden">
        <CardHeader className="border-b border-zinc-100 dark:border-zinc-900/60 pb-3 flex-shrink-0">
          <CardTitle className="text-base font-semibold flex items-center gap-2">
        ...
        <div className="p-4 overflow-y-auto max-h-[500px] select-text">
          {decisions.length === 0 ? (
