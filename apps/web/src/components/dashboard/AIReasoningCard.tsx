        ...
        {!latestDecision ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 flex items-center gap-4">
                <div className="p-3 bg-amber-500/10 text-amber-500 rounded-xl">
                  <Thermometer className="h-6 w-6" />
                </div>
                <div>
                  <div className="text-[11px] font-bold text-zinc-400 uppercase tracking-wider">HVAC Target</div>
                  <div className="text-xl font-bold text-zinc-950 dark:text-white mt-0.5">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 flex items-center gap-4">
                ...
                <div>
                  <div className="text-[11px] font-bold text-zinc-400 uppercase tracking-wider">Lighting Target</div>
                  <div className="text-xl font-bold text-zinc-950 dark:text-white mt-0.5">
            ...
            {/* Explanation text */}
            <div className="bg-emerald-500/5 dark:bg-emerald-950/10 border border-emerald-500/10 rounded-xl p-5">
              <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider block mb-2">Agent Rationale</span>
            ...
            <div className="flex items-center justify-between border-t border-zinc-100 dark:border-zinc-900 pt-4 text-xs">
              ...
              <div className="flex items-center gap-2">
                <span className="text-zinc-400 dark:text-zinc-500 font-semibold mr-1">Feedback:</span>
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => submitFeedback(latestDecision.id, "correct")}
                  className={`h-8 px-3 text-xs flex items-center gap-1.5 font-medium ${latestDecision.feedbackStatus === "correct" ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" : ""}`}
                >
                ...
                <Button
                  ...
                  className={`h-8 px-3 text-xs flex items-center gap-1.5 font-medium ${latestDecision.feedbackStatus === "incorrect" ? "bg-rose-500/10 text-rose-600 border-rose-500/20" : ""}`}
                >
